    ...
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safe} edges={["bottom"]}>
        ...
        <View style={styles.viewerWrap}>
          {!permission ? (
            <View style={styles.viewer}><ActivityIndicator color="#0d9488" /></View>
          ) : !permission.granted ? (
...
function MenuIcon() {
  return (<Svg width={20} height={20} viewBox="0 0 24 24" fill="none"><Path d="M4 6h16M4 12h16M4 18h16" stroke="#18181b" strokeWidth={2.2} strokeLinecap="round" /></Svg>);
}
function BackIcon() {
  return (<Svg width={16} height={16} viewBox="0 0 24 24" fill="none"><Path d="M19 12H5M12 19l-7-7 7-7" stroke="#18181b" strokeWidth={2.2} strokeLinecap="round" strokeLinejoin="round" /></Svg>);
}
...
const styles = StyleSheet.create({
  ...
  flashName: { fontSize: 18, fontWeight: "800", color: "#18181b" },
  ...
  corner: { position: "absolute", width: 28, height: 28, borderColor: "#5eead4", borderWidth: 3 },
  ...
  permBtn: { backgroundColor: "#0d9488", paddingHorizontal: 18, paddingVertical: 10, borderRadius: 10 },
  ...
  manualInput: { flex: 1, backgroundColor: "#f8fafc", color: "#18181b", borderColor: "#e2e8f0", borderWidth: 1, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14 },
  manualBtn: { backgroundColor: "#0d9488", paddingHorizontal: 16, justifyContent: "center", borderRadius: 10 },
